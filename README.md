...
6. Copy the **Extension ID** generated by Chrome for the RESOPT extension.
7. Run the native messaging script to connect the extension to your desktop app:
...
8. Restart your browser! The extension can now seamlessly talk to the desktop app securely without HTTP.
